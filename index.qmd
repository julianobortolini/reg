...
<!-- - Aula 5: Resolver a lista [Lista 1](lista1_2025-2_gab.html). Atenção, a lista já está resolvida usando o software R. -->

<!-- - [Lista 2](lista2_2025-2.html): mais sobre covariância e correlação. -->

<!-- - Aula 10: revisão dos conteúdos e correção da prova 1. Análise de regressão no `R`. [Atividade prática no `R`](AP_1_2025-2.html). -->


<!-- - [Lista 3](lista3_2025-2.html): ajuste de modelo linear simples no `R`. -->

<!-- - Aula 11: regressão linear múltipla, método de mínimos quadrados, modelo linear em forma matricial, propriedades dos estimadores de mínimos quadrados, estimação de $\sigma^2$, teste de hipóteses para regressão e coeficientes, intervalos de confiança para parâmetros, valor médio e novas observações. Exemplo: the delivery time data (livro do Montgomery). -->

<!-- - [Lista 4](lista4_2025-2.html): ajuste de modelo linear múltipla no `R`. -->

<!-- - Aula 12: análise de pressupostos, pontos influentes e discrepantes, regressão polinomial e variáveis indicadoras. [Análise no R](reg_comp_2025-2.html). Tarefa (valendo nota): 1. elaborar um texto (com funções em `R`) sobre os métodos de seleção de variáveis e de validação de modelos 2. resolver a [lista 5](lista5_2025-2.html).  -->

<!-- - [Lista 5](lista5_2025-2.html): análise de pressupostos, pontos influentes e discrepantes, regressão polinomial e variáveis indicadoras. -->
